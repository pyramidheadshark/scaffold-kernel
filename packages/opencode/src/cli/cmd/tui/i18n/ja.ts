...
export const dict = {
  ...
  "tui.dialog.login.mimo_free.success": "Scaffold (choose provider) の準備完了 — デフォルトモデルを mimo/mimo-auto に設定しました",
  "tui.dialog.login.mimo_free.unavailable": "Scaffold (choose provider) プロバイダーが読み込まれていません",
  ...
  "cli.providers.mimo_free.verifying": "Scaffold (choose provider) チャネルを検証中...",
  "cli.providers.mimo_free.ready": "Scaffold (choose provider) チャネル準備完了",
  "cli.providers.mimo_free.failed": "Scaffold (choose provider) の自己診断に失敗",
