export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using Scaffold, you agree to our ",
  ...
  "tui.tips.plain_terminal":
    "The default Mac terminal has rendering limitations. Please use iTerm2 or the VS Code terminal",
  ...
  "tui.tips.free_models": "Supports OpenRouter, Codex and other providers — add your key in Settings",
  "tui.tips.free_api_sunset":
    "The free API service has ended. Run {highlight}/login{/highlight} to sign in. Subscribe to the Scaffold Token Plan or configure a third-party API to use Scaffold.",
  ...
  "tui.tips.compose_next": "Try {highlight}/compose-next{/highlight} instead of the Compose agent for frontier models",
  ...
  "tui.tips.paste_image":
    "Press {highlight}Ctrl+V{/highlight} to paste images from your clipboard (on macOS use Ctrl+V, not Cmd+V — the terminal intercepts Cmd+V)",
  "tui.tips.editor":
  ...
  "tui.tips.config_files":
    "Create {highlight}scaffold.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config":
    "Place TUI settings in {highlight}~/.config/scaffold/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "Scaffold auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.scaffold/command/{/highlight} to define reusable custom prompts",
  "tui.tips.command_args":
    "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "tui.tips.command_backticks":
    "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.scaffold/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "Scaffold auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "Scaffold uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.scaffold/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.scaffold/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent Scaffold from reading sensitive files",
  "tui.tips.run": "Use {highlight}scaffold run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}scaffold --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}scaffold run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run scaffold serve for headless API access to Scaffold",
  "tui.tips.attach_server": "Use {highlight}scaffold run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}scaffold upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}scaffold auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}scaffold agent create{/highlight} for guided agent creation",
  "tui.tips.github_install": "Run {highlight}scaffold github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.scaffold/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}scaffold debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Scaffold for curated, tested models",
  ...
  "tui.skill.mimocode.description": "Self-documentation for Scaffold features, config, and commands",
  "tui.skill.evolve.description":
    "Rewrite any layer of yourself — tools, behavior hooks, knowledge, workflows, even the UI",
  ...
  "tui.skill.deep-research.description": "Deep multi-source investigation with cross-checked, cited reports",
  "tui.skill.modern-python-toolchain.description": "Modern Python project setup with uv, ruff, and pyright",
  ...
  "tui.context_limit.scalar_config":
    "compaction.max_context is set to a single value for all models — edit it in scaffold.json to switch to per-model limits",
  "tui.context_limit.shadowed": "Saved, but another config still forces {{value}} — check your project scaffold.json",
  ...
  "tui.visual_mode.enabled":
    "Vivid display enabled: star field and logo effects restored; meteors and animated activity follow the animation setting",
  "tui.visual_mode.disabled":
    "Vivid display disabled: stars, meteors, and logo effects hidden; activity indicators remain stable",
  ...
  "tui.dialog.free_api_sunset.message":
    "Run /login to sign in. Subscribe to the Scaffold Token Plan or configure a third-party API to use Scaffold.",
  ...
  "tui.model.mimo_auto.name": "Scaffold Auto (Scaffold-V2.5 free until Jul 26, 18:00 · UTC+8)",
  ...
  "tui.dialog.try_best.reason.action_streak": "{{count}} consecutive {{action}} actions made no observable progress.",
  ...
  "tui.dialog.try_best.handoff.description": "Ask Scaffold to delegate the unfinished work to this harness",
  ...
  "tui.toast.update_available.success":
    "Successfully updated to Scaffold v{{version}}. Please restart the application.",
  ...
  "tui.voice.error.no_auth": "Please log in to a provider first",
  ...
  "tui.dialog.login.flow.title": "Scaffold Provider Login",
  ...
  "trust.capabilities": "Scaffold will be able to read, edit, and execute files here.",
  "trust.plugin_warn":
  ...
  "skip_permissions.body":
    "You started with --dangerously-skip-permissions. Scaffold will read, edit, and execute files and run shell commands WITHOUT asking for approval. Only rules you have explicitly denied in config are still enforced. You are solely responsible for anything it does.",
