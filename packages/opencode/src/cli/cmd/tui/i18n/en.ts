export const dict: Record<string, string> = {
  ...
  "tui.tips.share": "Run {highlight}/export{/highlight} to save your conversation as Markdown, or {highlight}/share{/highlight} for a shareable link",
  ...
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/scaffold/tui.json{/highlight} for global config",
  ...
  "tui.tips.github_trigger": "Use {highlight}/scaffold{/highlight} in GitHub issues/PRs to trigger AI actions",
  ...
  "tui.tips.docker": "Run {highlight}scaffold run '...'  {/highlight} for headless non-interactive mode without TUI",
  ...
  "tui.toast.update_available.success": "Successfully updated to Scaffold v{{version}}. Please restart the application.",
  ...
  "tui.dialog.login.xiaomi": "Provider Login",
  ...
  "tui.dialog.login.mimo_free.success": "Scaffold (choose provider) is ready — choose your model via /models",
  "tui.dialog.login.mimo_free.unavailable": "Scaffold (choose provider) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.mimo.recommended_hint": "recommended",
  "cli.providers.mimo_free.hint": "Configure a provider via /connect or import from Claude Code",
  "cli.providers.mimo_free.verifying": "Verifying Scaffold (choose provider) channel...",
  "cli.providers.mimo_free.ready": "Scaffold (choose provider) channel ready",
  "cli.providers.mimo_free.failed": "Scaffold (choose provider) verification failed",
  "cli.providers.mimo_free.default_set": "Use /models to choose your default model",
  "cli.providers.mimo_free.usage_hint": "No login required — use scaffold run. For paid/premium models, choose provider settings /connect.",
