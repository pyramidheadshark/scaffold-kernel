...
export const dict = {
  ...
  "tui.tips.share": "运行 {highlight}/export{/highlight} 将对话保存为 Markdown，或 {highlight}/share{/highlight} 生成分享链接",
  ...
  "tui.tips.plugins":
    "在 {highlight}.scaffold/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  ...
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/scaffold{/highlight} 触发 AI 操作",
  ...
  "tui.tips.docker": "运行 {highlight}scaffold run '...'  {/highlight} 以无界面 headless 模式执行任务",
  ...
  "tui.dialog.login.mimo_free.desc": "选择服务商并配置 API 密钥",
  "tui.dialog.login.mimo_free.success": "Scaffold (choose provider) 已就绪 - 通过 /models 选择模型",
  "tui.dialog.login.mimo_free.unavailable": "Scaffold (choose provider) 通道未加载",
  "cli.providers.select": "选择服务商",
  "cli.providers.other": "其他 Provider",
  "cli.providers.mimo.recommended_hint": "推荐",
  "cli.providers.mimo_free.hint": "通过 /connect 配置服务商",
  "cli.providers.mimo_free.verifying": "正在验证 Scaffold (choose provider) 通道...",
  "cli.providers.mimo_free.ready": "Scaffold (choose provider) 通道已就绪",
  "cli.providers.mimo_free.failed": "Scaffold (choose provider) 自检失败",
  "cli.providers.mimo_free.default_set": "通过 /models 选择默认模型",
  "cli.providers.mimo_free.usage_hint": "无需登录，通过 /connect 配置服务商。如需付费/更高级模型，或通过 /login 从 Claude Code 导入。",
