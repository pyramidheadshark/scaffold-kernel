...
export const dict = {
  ...
  "tui.tips.share": "執行 {highlight}/export{/highlight} 將對話儲存為 Markdown，或 {highlight}/share{/highlight} 產生分享連結",
  ...
  "tui.tips.plugins":
    "在 {highlight}.scaffold/plugin/{/highlight} 加入 {highlight}.ts{/highlight} 檔案掛載事件勾點",
  ...
  "tui.tips.github_trigger": "在 GitHub issue/PR 中輸入 {highlight}/scaffold{/highlight} 觸發 AI 操作",
  ...
  "tui.tips.docker": "執行 {highlight}scaffold run '...'  {/highlight} 以無介面 headless 模式執行任務",
