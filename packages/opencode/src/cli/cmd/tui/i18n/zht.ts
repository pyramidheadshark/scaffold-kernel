...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 Scaffold 即表示你同意我們的",
  ...
  "tui.tips.free_api_sunset":
    "免費 API 服務已終止。請使用 {highlight}/login{/highlight} 登入，歡迎訂閱 Scaffold Token Plan 或設定第三方 API 後使用 Scaffold。",
  "tui.tips.multi_skills": "在同一則訊息中輸入多個 {highlight}/skill-name{/highlight} 可同時組合使用多個 Skills",
  "tui.tips.ask_slash_commands": "想找快捷指令？直接在聊天中問 {highlight}有哪些 slash 快捷指令？{/highlight}",
  ...
  "tui.tips.compose_next": "推薦前沿模型使用 {highlight}/compose-next{/highlight} 代替 Compose 智慧體",
  ...
  "tui.tips.paste_image":
    "按 {highlight}Ctrl+V{/highlight} 把剪貼簿中的圖片貼到輸入框（macOS 上請用 Ctrl+V，不要用 Cmd+V——Cmd+V 會被終端攔截）",
  ...
  "tui.tips.config_files":
    "建立 {highlight}scaffold.json{/highlight} 用於伺服器端設定，{highlight}tui.json{/highlight} 用於 TUI 設定",
  "tui.tips.global_config": "把 TUI 設定放在 {highlight}~/.config/scaffold/tui.json{/highlight} 作為全域設定",
  ...
  "tui.tips.mcp_oauth": "Scaffold 自動處理需要驗證的遠端 MCP 伺服器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.scaffold/command/{/highlight} 加入 {highlight}.md{/highlight} 檔案以定義可重用自訂提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.scaffold/agent/{/highlight} 加入 {highlight}.md{/highlight} 檔案來建立專用 AI 角色",
  ...
  "tui.tips.formatter": "Scaffold 自動使用 prettier、gofmt、ruff 等格式化檔案",
  ...
  "tui.tips.lsp": "Scaffold 使用 LSP 伺服器進行智慧程式碼分析",
  "tui.tips.custom_tool":
    "在 {highlight}.scaffold/tools/{/highlight} 建立 {highlight}.ts{/highlight} 檔案定義新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定義可呼叫 Python、Go 等指令稿",
  "tui.tips.plugins": "在 {highlight}.scaffold/plugin/{/highlight} 加入 {highlight}.ts{/highlight} 檔案掛載事件勾點",
  "tui.tips.plugin_notify": "用外掛在工作階段完成時傳送系統通知",
  "tui.tips.plugin_protect": "撰寫一個外掛阻止 Scaffold 讀取敏感檔案",
  "tui.tips.run": "用 {highlight}scaffold run{/highlight} 進行非互動式指令稿呼叫",
  "tui.tips.continue": "用 {highlight}scaffold --continue{/highlight} 繼續上一個工作階段",
  "tui.tips.attach_cli": "用 {highlight}scaffold run -f file.ts{/highlight} 透過命令列附加檔案",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在指令稿中取得機器可讀輸出",
  "tui.tips.serve": "執行 scaffold serve 以無介面模式提供 Scaffold API",
  "tui.tips.attach_server": "用 {highlight}scaffold run --attach{/highlight} 連線到正在執行的服務",
  "tui.tips.upgrade": "執行 {highlight}scaffold upgrade{/highlight} 升級到最新版本",
  "tui.tips.auth_list": "執行 {highlight}scaffold auth list{/highlight} 檢視所有已設定的供應商",
  "tui.tips.agent_create": "執行 {highlight}scaffold agent create{/highlight} 引導式建立智慧代理",
  "tui.tips.github_install": "執行 {highlight}scaffold github install{/highlight} 設定 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.scaffold/themes/{/highlight} 目錄下建立 JSON 主題檔案",
  ...
  "tui.tips.debug_config": "執行 {highlight}scaffold debug config{/highlight} 排查設定問題",
  ...
  "tui.tips.zen": "搭配 Scaffold 使用 {highlight}/connect{/highlight} 選用經過測試的精選模型",
  ...
  "tui.skill.mimocode.description": "Scaffold 功能、設定與命令的自文件參考",
  ...
  "tui.skill.super-research.description":
    "自主研究——實驗迴圈、主題調研、量化分析、對比評測、根因排查、消融實驗、複現論文、寫論文",
  ...
  "tui.skill.mimocode.slash": "Scaffold文件",
  ...
  "tui.context_limit.scalar_config":
    "compaction.max_context 目前是對所有模型生效的單值，請在 scaffold.json 中改為依模型設定",
  "tui.context_limit.shadowed": "已儲存，但仍有其他設定將其固定為 {{value}}，請檢查專案的 scaffold.json",
  ...
  "tui.dialog.free_api_sunset.message":
    "請使用 /login 登入，歡迎訂閱 Scaffold Token Plan 或設定第三方 API 後使用 Scaffold。",
  ...
  "tui.dialog.try_best.handoff.description": "讓 Scaffold 將未完成的工作委派給此 harness",
  ...
  "tui.toast.update_available.success": "已更新到 Scaffold v{{version}}，請重新啟動應用程式。",
  ...
  "tui.voice.error.no_auth": "請先登入服務商帳號",
  ...
  "trust.capabilities": "Scaffold 將能夠讀取、編輯和執行此目錄中的檔案。",
  ...
  "tui.dialog.login.flow.title": "Scaffold 登入",
